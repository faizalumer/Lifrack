...
public class HabitDaoImpl extends SqliteDaoBase implements IHabitDao{
	...
	public int delete(long habitId){
		int habitCount = db.delete(Table_Habits.TABLE_NAME, Table_Habits.COLUMN_ID + "=?", new String[]{String.valueOf(habitId)});
		return habitCount;
	}
