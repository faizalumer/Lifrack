...
public class HabitOperationsManagerImpl extends SqliteDaoBase implements IHabitOperationsManagerDao{
	
	public HabitOperationsManagerImpl(SQLiteDatabase db) {
		super(db);
	}
	...
	public boolean deleteArchivedHabit(long habitId){
		...
		try {
			...
			//delete hit sessions
			new HitSessionHistoryDaoImpl(db).deleteByHabitId(habitId);
			//db.delete(Table_HabitHitSessions.TABLE_NAME, Table_HabitHitSessions.COLUMN_HABIT_ID + "=?", selectArgs);
			
			//delete hits
			new HitHistoryDaoImpl(db).deleteByHabitId(habitId);
			//db.delete(Table_HabitHits.TABLE_NAME, Table_HabitHits.COLUMN_HABIT_ID + "=?", selectArgs);
			
			//delete targets
			new TargetHistoryDaoImpl(db).deleteByHabitId(habitId);
			//db.delete(Table_HabitTargets.TABLE_NAME, Table_HabitTargets.COLUMN_HABIT_ID + "=?", selectArgs);
			
			//delete schedules
			new ScheduleHistoryDaoImpl(db).deleteByHabitId(habitId);
			//db.delete(Table_HabitSchedules.TABLE_NAME, Table_HabitSchedules.COLUMN_HABIT_ID + "=?", selectArgs);
			...
			//delete habit
			int habitCount = new HabitHistoryDaoImpl(db).delete(habitId);
			//int habitCount = db.delete(Table_Habits.TABLE_NAME, Table_Habits.COLUMN_ID + "=?", selectArgs);
